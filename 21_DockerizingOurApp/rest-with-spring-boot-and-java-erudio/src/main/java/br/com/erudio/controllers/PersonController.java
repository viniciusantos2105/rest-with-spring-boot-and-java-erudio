...
public class PersonController {
	...
	@GetMapping(value = "/findPersonsByName/{firstName}", produces = { MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findPersonsByNames(
		...
		Pageable pageable = PageRequest.of(page, size, Sort.by(sortDirection, "firstName"));
		return ResponseEntity.ok(service.findPersonsByNames(firstName, pageable));
	}
